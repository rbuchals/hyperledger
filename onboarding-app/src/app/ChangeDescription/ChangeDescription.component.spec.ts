...
import { ChangeDescriptionComponent } from './ChangeDescription.component';
...
describe('ChangeDescriptionComponent', () => {
  ...
  let mockChangeDescriptionService;
  let mockDataService

  beforeEach(async(() => {

    mockChangeDescriptionService = sinon.createStubInstance(ChangeDescriptionService);
    mockChangeDescriptionService.getAll.returns([]);
    ...
    TestBed.configureTestingModule({
      ...
      providers: [
        {provide: ChangeDescriptionService, useValue: mockChangeDescriptionService },
