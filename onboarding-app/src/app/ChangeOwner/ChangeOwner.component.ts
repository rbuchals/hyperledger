...
export class ChangeOwnerComponent implements OnInit {
  ...
  newPartnerId = new FormControl('', Validators.required);
  ...
  constructor(private serviceChangeOwner: ChangeOwnerService, fb: FormBuilder) {
    this.myForm = fb.group({
      ...
      newPartnerId: this.newPartnerId,
  ...
  addTransaction(form: any): Promise<any> {
    this.Transaction = {
      $class: 'org.onboarding.auction.ChangeOwner',
      'assetId': this.assetId.value,
      'newPartnerId': this.newPartnerId.value,
  ...
  getForm(id: any): Promise<any> {
    ...
    .then((result) => {
      ...
      if (result.newPartnerId) {
        formObject.newPartnerId = result.newPartnerId;
      } else {
        formObject.newPartnerId = null;
      }
